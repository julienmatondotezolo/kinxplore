...
export default function InfoCurrencyPage() {
  const t = useTranslations("InfoCurrency");
      ...
      <div className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <Link
              href="/trip-planning"
              className="inline-flex items-center gap-2 px-8 py-4 bg-green-600 hover:bg-green-700 text-white rounded-xl font-bold hover:shadow-lg transition-all"
            >
              {t("cta")}
