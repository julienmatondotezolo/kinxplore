...
export default function InfoTravelPage() {
  const t = useTranslations("InfoTravel");
  ...
  const sections = [
    {
      ...
      title: t("s1Title"),
      text: t("s1Text"),
      items: [t("s1Item1"), t("s1Item2"), t("s1Item3"), t("s1Item4")],
    },
    {
      icon: Sun,
      title: t("s2Title"),
      text: t("s2Text"),
      items: [t("s2Item1"), t("s2Item2"), t("s2Item3"), t("s2Item4")],
    },
    {
      icon: Heart,
      title: t("s3Title"),
    ...
    },
    {
      ...
      title: t("s4Title"),
      text: t("s4Text"),
      items: [t("s4Item1"), t("s4Item2"), t("s4Item3"), t("s4Item4")],
    },
    {
      icon: Wifi,
      title: t("s5Title"),
