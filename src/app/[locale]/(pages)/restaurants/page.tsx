...
export default function RestaurantsPage() {
  ...
  const restaurants = (destinations || []).filter((dest) =>
    dest.categories?.some(
      (cat) => cat.parent?.name?.toLowerCase() === "restaurant"
    )
  );
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-32 bg-blue-50/50 rounded-3xl border-2 border-dashed border-blue-200">
              <UtensilsCrossed size={64} className="mx-auto text-blue-300 mb-6 stroke-[1.5]" />
