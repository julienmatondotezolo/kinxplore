...
export default function CityTransferPage() {
  ...
  const features = [
    t("cityTransferFeature1"),
    t("cityTransferFeature2"),
    t("cityTransferFeature3"),
    t("cityTransferFeature4"),
    t("cityTransferFeature5"),
  ];
      ...
      <div className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-white rounded-2xl p-8 border border-gray-100 mb-8"
          >
            <p className="text-gray-600 leading-relaxed">{t("cityTransferDescription")}</p>
          </motion.div>
