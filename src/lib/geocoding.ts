...
export const KINSHASA_NEIGHBORHOODS = {
  ...
  ngaliema: { lat: -4.37, lng: 15.26, name: "Ngaliema" },
  kalamu: { lat: -4.34, lng: 15.31, name: "Kalamu" },
  lemba: { lat: -4.39, lng: 15.33, name: "Lemba" },
  matete: { lat: -4.38, lng: 15.29, name: "Matete" },
  ngiri_ngiri: { lat: -4.35, lng: 15.29, name: "Ngiri-Ngiri" },
  kinshasa_center: { lat: -4.3276, lng: 15.3136, name: "Kinshasa Center" },
  masina: { lat: -4.385, lng: 15.39, name: "Masina" },
  ndjili: { lat: -4.395, lng: 15.42, name: "Ndjili" },
  kimbanseke: { lat: -4.42, lng: 15.34, name: "Kimbanseke" },
};
...
export function isValidCoordinate(lat: number, lng: number): boolean {
  return (
    !isNaN(lat) && !isNaN(lng) && lat !== null && lng !== null && lat >= -90 && lat <= 90 && lng >= -180 && lng <= 180
  );
}
