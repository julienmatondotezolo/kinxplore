...
export const TripChat: React.FC<TripChatProps> = ({ initialMessage, onClose }) => {
  ...
  const { messages, currentResponse, isLoading, error, sendMessage } = useTripChat();
  ...
  return (
    <div className="flex flex-col h-full bg-gradient-to-br from-blue-50/50 via-purple-50/30 to-pink-50/40">
      {/* Header */}
